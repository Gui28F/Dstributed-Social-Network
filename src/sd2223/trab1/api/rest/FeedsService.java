...
public interface FeedsService {
    ...
    @Path("/{" + USER + "}")
    @Produces(MediaType.APPLICATION_JSON)
    List<Message> getMessages(@HeaderParam(FeedsService.HEADER_VERSION) Long version, @PathParam(USER) String user, @QueryParam(TIME) long time);
    ...
    @Path("/sub/list/{" + USER + "}")
    @Produces(MediaType.APPLICATION_JSON)
    List<String> listSubs(@HeaderParam(FeedsService.HEADER_VERSION) Long version, @PathParam(USER) String user);
    ...
    @Path("/server/{" + VERSION + "}")
    @Consumes(MediaType.APPLICATION_JSON)
    void postServerInfo(@QueryParam(SECRET) String secret, String info, @PathParam(VERSION) long version);
