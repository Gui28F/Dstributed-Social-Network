...
docker pull nunopreguica/sd2223-tester-tp2:latest
docker run --rm --network=sdnet -it -v /var/run/docker.sock:/var/run/docker.sock nunopreguica/sd2223-tester-tp2 $*
